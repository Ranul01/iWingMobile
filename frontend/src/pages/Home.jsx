    ...
    <div className="bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-6xl md:text-8xl font-bold mb-10 bg-gradient-to-r from-yellow-400 via-purple-500 to-blue-500 bg-clip-text text-transparent">
            iWingMobile
          </h1>
...
//             <Link
//               to="/accessories"
//               className="inline-flex items-center bg-yellow-400 text-black px-8 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors"
//             >
