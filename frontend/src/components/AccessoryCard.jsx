...
const AccessoryCard = ({ accessory }) => {
  ...
  const handleBuyNow = (e) => {
    ...
    // Create WhatsApp message with accessory details
    const message = `Hi, I'm interested in buying ${accessory.name} (${
      accessory.brand
  ...
  if (isOutOfStock) {
    ...
    buttonClass =
      "w-full py-2 px-4 rounded-lg font-medium bg-gray-300 text-gray-500 cursor-not-allowed flex items-center justify-center";
  } else {
    buttonLabel = "Buy Now";
    buttonClass =
      "w-full py-2 px-4 rounded-lg font-medium bg-yellow-400 text-black hover:bg-yellow-500 transition-colors flex items-center justify-center";
  }
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        >
          {!isOutOfStock && <FaWhatsapp className="mr-2" />}
          {buttonLabel}
        </button>
      </div>
    </div>
